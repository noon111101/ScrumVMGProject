...
public class ExcelController {
    ...
    @GetMapping("/export")
    public ResponseEntity exportToExcel(@RequestParam Long id,@RequestParam int month, HttpServletResponse response) throws IOException {
        ...
        List<LogDetail> listLogs = logDetailRepository.findByMonthAndDepartmentSortDate(id, month);
